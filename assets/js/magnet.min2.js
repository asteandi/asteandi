...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  "tHPN": [function (require, module, exports) {
    ...
    var ButtonCtrl = /*#__PURE__*/ function (_EventEmitter) {
      ...
      function ButtonCtrl(el) {
        ...
        _this.DOM.text = _this.DOM.el.querySelector('.button-text2');
        _this.DOM.textinner = _this.DOM.el.querySelector('.button-text-inner2');
        _this.DOM.deco = _this.DOM.el.querySelector('.button-deco2');
        _this.DOM.filler = _this.DOM.deco.querySelector('.button-filter2'); // amounts the button will translate/scale
  ...
  "ZSzT": [function (require, module, exports) {
    ...
    var cursor = new _cursor.default(document.querySelector('.cursor2'));
    var button = new _buttonCtrl.default(document.querySelector('.button2'));
