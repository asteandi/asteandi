...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  "tHPN": [function (require, module, exports) {
    ...
    var ButtonCtrl = /*#__PURE__*/ function (_EventEmitter) {
      ...
      function ButtonCtrl(el) {
        ...
        _this.DOM.text = _this.DOM.el.querySelector('.button-text3');
        _this.DOM.textinner = _this.DOM.el.querySelector('.button-text-inner3');
        _this.DOM.deco = _this.DOM.el.querySelector('.button-deco3');
        _this.DOM.filler = _this.DOM.deco.querySelector('.button-filter3'); // amounts the button will translate/scale
  ...
  "ZSzT": [function (require, module, exports) {
    ...
    var cursor = new _cursor.default(document.querySelector('.cursor3'));
    var button = new _buttonCtrl.default(document.querySelector('.button3'));
